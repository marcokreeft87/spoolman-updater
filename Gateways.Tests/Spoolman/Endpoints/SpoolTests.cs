...
namespace Gateways.Tests
{
    internal class SpoolTests : EndpointTest<SpoolSpoolmanEndpoint>
    {
        ...
        public override void SetupHttpClient(MockHttpMessageHandler mockHandler)
        {
            ...
            //JsonSerializer.Serialize(new List<Spool>()
            //   {
            //        new Spool()
            //        {
            //            Id = 1,
